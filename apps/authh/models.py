...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    groups = models.ManyToManyField(Group, verbose_name='Grupo', related_name='grupos', blank=True)
    user_permissions = models.ManyToManyField(Permission, related_name='permissoes', blank=True)
    ...
    # Snão quiser assim altere essa linha
